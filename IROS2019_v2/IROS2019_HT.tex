...
\begin{figure}[h!]
	...
	\caption{The plot of Root-Mean-Square-Error (RMSE) with respect to the sequence length for various numbers of anchors.}
...
\begin{figure}[h]
	...
	\caption{Box plot of results w.r.t. the number of anchors.}
	\label{fig:box_plot} 	
\end{figure}
